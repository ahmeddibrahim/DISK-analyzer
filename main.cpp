        ...
        while ((this_entry = readdir(current_directory))!= NULL)
        {
            ...
            if ((strcmp(this_entry->d_name,".") != 0) && (strcmp(this_entry->d_name,"..") != 0))
            {
                ...
                // /* If this is a nested directory,process it */
                    ...
                    a.tree= NewTree;
                    a.my_tree=Ntree;
                    //onedir(indent+2,this_entry->d_name,NewTree,totalsize);
                    //cout<<a.name<<" size = "<<abs(nbytes-Ntree->size)<<endl;
                    //a.size=abs(nbytes-Ntree->size);
                    Ntree->insert(a);
                    //a.path=name;
                    ndirectories++; 
                 }
...
int main()
{
    char* name ="/Users/ahmedibrahim/desktop/projects";
